...
st.set_page_config(page_title="DiaPlanApp", layout="wide")
...
# Nagłówek
st.markdown("""
    <div class='main-header'>DiaPlanApp</div>
    <div class='sub-header'>Automatyzacja diety dla diabetyków</div>
    <div class='desc-text'>Zarządzaj produktami spożywczymi i planuj dietę dostosowaną do potrzeb cukrzycowych</div>
    <br>
""", unsafe_allow_html=True)
...
st.markdown("""
    <hr>
    <p style='text-align: center; font-size: 0.8em;'>DiaPlanApp – prototyp aplikacji dyplomowej do automatyzacji diety dla diabetyków</p>
""", unsafe_allow_html=True)
